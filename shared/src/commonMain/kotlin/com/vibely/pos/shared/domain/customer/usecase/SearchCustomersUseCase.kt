...
class SearchCustomersUseCase(private val customerRepository: CustomerRepository) {
    suspend operator fun invoke(query: String): Result<List<Customer>> = customerRepository.search(query)
}
